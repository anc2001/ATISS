...
def main(argv):
    ...
    if contains_query:
        ...
        query_folder = scene_folder / "query_mesh"
    ...
    mesh_folder = scene_folder / "scene_mesh"
    ...
    # Do the rendering
    path_to_image = scene_folder / "atiss_viz.png"
